const plans = [
  ...
  },
  {
    ...
    price: "$1,499",
    popular: true,
    description: "Our most popular solution for growing businesses.",
    features: [
      "Complete website",
      "AI chatbot",
      "Booking system",
  ...
  },
  {
    name: "Enterprise",
    price: "Custom",
    description: "Tailored AI automation for larger organizations.",
    features: [
      "Custom AI workflows",
      "Voice AI",
      "CRM automation",
  ...
  return (
    <section id="pricing" className="mx-auto max-w-7xl px-6 py-24">
      ...
      <p className="mt-6 max-w-3xl text-lg text-gray-400">
        Transparent pricing designed to fit businesses at every stage of
        growth.
      </p>
      ...
      <div className="mt-16 grid gap-8 lg:grid-cols-3">
        {plans.map((plan) => (
          ...
          >
            ...
            <button className="mt-10 w-full rounded-full bg-white py-4 font-bold text-black transition hover:bg-blue-100">
              Choose Plan
            </button>
          </div>
        ))}
