      ...
      {open && (
        <div className="fixed bottom-28 right-6 z-[9999] w-[360px] max-w-[calc(100vw-48px)] overflow-hidden rounded-3xl border border-white/10 bg-[#0B1220] text-white shadow-2xl">
          <div className="bg-blue-600 p-5">
            <h3 className="text-xl font-bold">JOHAI Assistant</h3>
            <p className="text-sm text-blue-100">
              Ask anything about AI automation.
            </p>
          </div>
          ...
          <div className="h-80 space-y-4 overflow-y-auto p-5">
            ...
            <div className="ml-auto rounded-2xl bg-blue-600 p-4">
              Example: I own a dental clinic.
            </div>

            <div className="rounded-2xl bg-white/10 p-4">
              JOHAI can automate appointment booking, reminders, patient FAQs,
          ...
          <div className="flex gap-3 border-t border-white/10 p-4">
            ...
            <button className="rounded-xl bg-blue-600 px-4 transition hover:bg-blue-500">
              <Send size={18} />
            </button>
          </div>
        </div>
