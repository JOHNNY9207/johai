        ...
        <div className="grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mt-6 leading-8 text-gray-300">
              Tell us about your business. JOHAI will identify what can be
              automated to save time, capture leads and increase revenue.
            </p>
            <div className="mt-8 rounded-2xl bg-black/30 p-5">
              <p className="font-bold text-white">What you get:</p>
              <ul className="mt-4 space-y-3 text-gray-400">
                <li>Automation opportunity review</li>
                <li>AI chatbot recommendation</li>
                <li>Website and lead system audit</li>
                <li>Clear action plan</li>
              </ul>
            </div>
            <CalendlyBookingButton className="mt-6 inline-flex items-center justify-center gap-2 rounded-full bg-blue-600 px-6 py-3 font-bold text-white transition hover:bg-blue-500" />
          </div>
